            ...
            <h1>Integrantes</h1>
                ...
                <div style={{ display:'flex', flexDirection:'row', flexWrap:'wrap', alignItems:'center', justifyContent:'center'}}>
                    <BoxPerfil class="box-perfil">
                        <Fundo>
                            <img class="fundo" src={fundo1}alt=""/>
                        </Fundo>
                        <Perfil>
                            <img class="perfil" src={Israel} alt=""/>
                        </Perfil>
                    ...
                    <BoxPerfil class="box-perfil">
                        <Fundo>
                            <img class="fundo" src={fundo2}alt=""/>
                        </Fundo>
                        <Perfil>
                            <img class="perfil" src={Julia} alt=""/>
                        </Perfil>
                        <div class="texto-perfil">
                    ...
                    <BoxPerfil class="box-perfil">
                        <Fundo>
                            <img class="fundo" src={fundo3} alt=""/>
                        </Fundo>
                        <Perfil>
                            <img class="perfil" src={Nalanda} alt=""/>
                        </Perfil>
                        <div class="texto-perfil">
                    ...
                    <BoxPerfil class="box-perfil">
                        <Fundo>
                            <img class="fundo" src={fundo4} alt=""/>
                        </Fundo>
                        <Perfil>
                            <img class="perfil" src={PedroScardua} alt=""/>
                        </Perfil>
                        <div class="texto-perfil">
                    ...
                    <BoxPerfil class="box-perfil">
                        ...
                        <Perfil>
                            <img class="perfil" src={"https://media.licdn.com/dms/image/C4D03AQH8c9bZyKjp-w/profile-displayphoto-shrink_200_200/0/1655269972981?e=1700697600&v=beta&t=mXgDU2UOFVlo7_k8OyqB3bRmUmhGIHTXoKjskNhdSio"} alt=""/>
                        </Perfil>
                        <div class="texto-perfil">
                 ...
                 <div className="info" style={{ marginTop:'20px', textAlign:'justify'}}>
              <h1>Sobre o Projeto</h1>
              <h4>Home / <strong>Sobre o Projeto</strong></h4>
              <div className="paragrafo">
                <h1 className="sobre-titulo">Promovendo a Sustentabilidade com a Inovação Digital na Schneider</h1>
                <h2 className="sub-titulo">Introdução:</h2>
              ...
              <div className="paragrafo">
                <h2 className="sub-titulo">Sobre Nos:</h2>
                <p className="texto-paragrafo">
              ...
              <div className="paragrafo">
                <h2 className="sub-titulo">Desenvolvimento:</h2>
                <p className="texto-paragrafo">
